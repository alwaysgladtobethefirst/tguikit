...
- **SSR-safe.** Platform / appearance / Telegram detection is `typeof window` guarded; the provider follows the theme through `useSyncExternalStore`, so no hydration flash (#12, #13, #16, #76).
